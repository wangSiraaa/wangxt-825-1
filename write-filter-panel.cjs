...
const filterPanelContent = `import React, { useState } from 'react';
...
fs.writeFileSync('/Users/mingyuan/workspace/sihuo/wangxtw3/825/src/components/FilterPanel.tsx', filterPanelContent);
console.log('FilterPanel.tsx written successfully');
